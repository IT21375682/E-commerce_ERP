...
const ViewCustomer = () => {
  ...
  useEffect(() => {
    ...
    const fetchVendorDetails = async () => {
      try {
        const response = await axios.get(`https://localhost:5004/api/User/${customerId}`); // Replace with actual endpoint
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      await axios.put(`https://localhost:5004/api/User/${customerId}`, formData); // Replace with actual endpoint
